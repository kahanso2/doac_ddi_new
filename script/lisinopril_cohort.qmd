...
build_manuscript_tables <- function(
  ...
  # --- Paths ---
  oac_shrunk_path <- file.path(proj_root, "results",
                               paste0(label, "_shrunk_", prior_suffix, ".rds"))
  ddi_path <- file.path(proj_root, "results", "ratio_of_ratios",
                        paste0("ddi_screen_table_", label, "_", prior_suffix, ".rds"))
  res_unadj_path <- file.path(proj_root, "results",
...
manuscript_tables <- build_manuscript_tables(proj_root, "unadjusted", "prior025")
...
build_full_supp_ddi_table <- function(
  ...
  ror_unadj_path <- file.path(
    proj_root, "results", "ratio_of_ratios",
  ...
  supp_gt <- supp %>%
    gt() %>%
    tab_header(
      title = "Supplement: Full Semi-Bayes and Ratio-of-Ratios Results for All Evaluated Precipitants"
    ) %>%
