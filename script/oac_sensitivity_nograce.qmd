...
ccaed_oac_2009_2021 <- extract_drug_name_data(
  ...
  output_path = file.path(proj_root, "data", "sensitivity_nograce_oac", "ccaed_oac_2009_2021.parquet"), 
  enrolid_filter = NULL,
  ndc_filter = oac_ndc
)
...
mdcrd_oac_2009_2021 <- extract_drug_name_data(
  ...
  output_path = file.path(proj_root, "data", "sensitivity_nograce_oac", "mdcrd_oac_2009_2021.parquet"), 
  enrolid_filter = NULL,
  ndc_filter = oac_ndc)
...
all_drug_oac_2009_2021 |> write_parquet(file.path(proj_root, "data", "sensitivity_nograce_oac", "all_drug_oac_2009_2021.parquet"))

#### CODE TO OPEN DATASET WITHOUT RUNNING ABOVE ####

# Open dataset
# all_drug_oac_2009_2021 <- read_parquet(file.path(proj_root, "data", "sensitivity_nograce_oac", "all_drug_oac_2009_2021.parquet"))
...
write_parquet(cleaned_drug_data, file.path(proj_root, "data", "sensitivity_nograce_oac", "cleaned_drug_data.parquet"))

# ── (Optional) Open dataset later without rerunning cleaning ────────────────────
# cleaned_drug_data <- read_parquet(file.path(proj_root, "data", "sensitivity_nograce_oac", "cleaned_drug_data.parquet"))
...
postclean_assign_rules_dt <- function(df,
 ...
 # previous end of exposure in each ENROLID (NA for first fill)
dt[, prev_end := data.table::shift(drug_end_plus_grace), by = ENROLID]

# days since last end; first row will be NA
dt[, days_since_last := as.integer(SVCDATE - prev_end)]

# new episode if:
#  - it's the first fill in that ENROLID (prev_end is NA), OR
#  - the gap exceeds gap_allowed
dt[, gap_flag := fifelse(
  is.na(prev_end) | days_since_last > gap_allowed,
  1L,
  0L
), by = ENROLID]
...
# Save dataset so don't have to do that again
write_parquet(all_oac_index, file.path(proj_root, "data", "sensitivity_nograce_oac", "all_oac_index.parquet"))

# Open dataset
# all_oac_index <- read_parquet(file.path(proj_root, "data", "sensitivity_nograce_oac", "all_oac_index.parquet"))
...
write_parquet(continuous_enrollment_result, file.path(proj_root, "data", "sensitivity_nograce_oac", "continuous_enrollment_result.parquet")) 
```
...
all_enroll |> write_parquet(file.path(proj_root, "data", "sensitivity_nograce_oac", "enrollment_parquet.parquet")) 

# Read parquet file back into the environment
enrollment_parquet <- read_parquet(file.path(proj_root, "data", "sensitivity_nograce_oac", "enrollment_parquet.parquet")) 
...
write_parquet(all_oac_index_ce, file.path(proj_root, "data", "sensitivity_nograce_oac", "all_oac_index_ce.parquet"))

# Reopen if needed
all_oac_index_ce <- read_parquet(file.path(proj_root, "data", "sensitivity_nograce_oac", "all_oac_index_ce.parquet"))
...
write_parquet(
  oac_cohort,
  file.path(proj_root, "data", "sensitivity_nograce_oac","oac_cohort.parquet")
)

# oac_cohort <- read_parquet(file.path(proj_root, "data", "sensitivity_nograce_oac", "oac_cohort.parquet"))
...
ccae_bleed_outcome_no_trauma <- identify_bleed_outcome(
  ...
  output_path_event = "C:/Users/kahanso2/OneDrive - University of Illinois Chicago/Documents_Backup_Microsoft/doac_ddi_new/data/sensitivity_nograce_oac/ccae_bleed_outcome_no_trauma.parquet"
)
...
mdcr_bleed_outcome_no_trauma <- identify_bleed_outcome(
  ...
  output_path_event = "C:/Users/kahanso2/OneDrive - University of Illinois Chicago/Documents_Backup_Microsoft/doac_ddi_new/data/sensitivity_nograce_oac/mdcr_bleed_outcome_no_trauma.parquet"
)
...
all_outcome |> write_parquet("C:/Users/kahanso2/OneDrive - University of Illinois Chicago/Documents_Backup_Microsoft/doac_ddi_new/data/sensitivity_nograce_oac/all_inpatient_bleed_no_trauma.parquet")

# Read in datasets if needed
# ccae_bleed_outcome_no_trauma <- read_parquet("C:/Users/kahanso2/OneDrive - University of Illinois Chicago/Documents_Backup_Microsoft/doac_ddi_new/data/sensitivity_nograce_oac/ccae_bleed_outcome_no_trauma.parquet")
# mdcr_bleed_outcome_no_trauma <- read_parquet("C:/Users/kahanso2/OneDrive - University of Illinois Chicago/Documents_Backup_Microsoft/doac_ddi_new/data/sensitivity_nograce_oac/mdcr_bleed_outcome_no_trauma.parquet")

all_inpatient_bleed_no_trauma <- read_parquet("C:/Users/kahanso2/OneDrive - University of Illinois Chicago/Documents_Backup_Microsoft/doac_ddi_new/data/sensitivity_nograce_oac/all_inpatient_bleed_no_trauma.parquet")
...
write_rds(analytic_cohort_oac, "C:/Users/kahanso2/OneDrive - University of Illinois Chicago/Documents_Backup_Microsoft/doac_ddi_new/data/sensitivity_nograce_oac/analytic_cohort_oac.rds")
...
# Apixaban
write_rds(dataset_for_loop_apixaban, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_apixaban.rds"))
write_rds(dataset_for_loop_outcome_apixaban, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_outcome_apixaban.rds"))
write_rds(apixaban_cohort, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/apixaban_cohort.rds"))
write_rds(apixaban_vector, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/apixaban_vector.rds"))

# Rivaroxaban
write_rds(dataset_for_loop_rivaroxaban, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_rivaroxaban.rds"))
write_rds(dataset_for_loop_outcome_rivaroxaban, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_outcome_rivaroxaban.rds"))
write_rds(rivaroxaban_cohort, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/rivaroxaban_cohort.rds"))
write_rds(rivaroxaban_vector, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/rivaroxaban_vector.rds"))

# Dabigatran
write_rds(dataset_for_loop_dabigatran, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_dabigatran.rds"))
write_rds(dataset_for_loop_outcome_dabigatran, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_outcome_dabigatran.rds"))
write_rds(dabigatran_cohort, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dabigatran_cohort.rds"))
write_rds(dabigatran_vector, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dabigatran_vector.rds"))

# Warfarin
write_rds(dataset_for_loop_warfarin, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_warfarin.rds"))
write_rds(dataset_for_loop_outcome_warfarin, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_outcome_warfarin.rds"))
write_rds(warfarin_cohort, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/warfarin_cohort.rds"))
write_rds(warfarin_vector, file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/warfarin_vector.rds"))
...
# Apixaban
dataset_for_loop_apixaban         <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_apixaban.rds"))
dataset_for_loop_outcome_apixaban <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_outcome_apixaban.rds"))
apixaban_cohort                   <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/apixaban_cohort.rds"))
apixaban_vector                   <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/apixaban_vector.rds"))

# Rivaroxaban
dataset_for_loop_rivaroxaban         <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_rivaroxaban.rds"))
dataset_for_loop_outcome_rivaroxaban <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_outcome_rivaroxaban.rds"))
rivaroxaban_cohort                   <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/rivaroxaban_cohort.rds"))
rivaroxaban_vector                   <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/rivaroxaban_vector.rds"))

# Dabigatran
dataset_for_loop_dabigatran         <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_dabigatran.rds"))
dataset_for_loop_outcome_dabigatran <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_outcome_dabigatran.rds"))
dabigatran_cohort                   <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dabigatran_cohort.rds"))
dabigatran_vector                   <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dabigatran_vector.rds"))

# Warfarin
dataset_for_loop_warfarin         <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_warfarin.rds"))
dataset_for_loop_outcome_warfarin <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/dataset_for_loop_outcome_warfarin.rds"))
warfarin_cohort                   <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/warfarin_cohort.rds"))
warfarin_vector                   <- read_rds(file.path(proj_root, "/data/sensitivity_nograce_oac/loop_datasets/warfarin_vector.rds"))
...
data.table::fwrite(res_unadj, file.path(proj_root, "results/sensitivity_nograce_oac/sccs_results_unadjusted.csv"))
saveRDS(res_unadj, file.path(proj_root, "results/sensitivity_nograce_oac/sccs_results_unadjusted.rds"))
...
data.table::fwrite(res_adj, file.path(proj_root, "results/sensitivity_nograce_oac/sccs_results_adjusted.csv"))
saveRDS(res_adj, file.path(proj_root, "results/sensitivity_nograce_oac/sccs_results_adjusted.rds"))
...
res_unadj <- readRDS(file.path(proj_root, "results/sensitivity_nograce_oac/sccs_results_unadjusted.rds"))

# OR (if you prefer CSV)
# res_unadj <- data.table::fread(file.path(proj_root, "results/sensitivity_nograce_oac/control/sccs_results_unadjusted.csv"))

# Read adjusted results
res_adj <- readRDS(file.path(proj_root, "results/sensitivity_nograce_oac/sccs_results_adjusted.rds"))

# OR (if you prefer CSV)
# res_adj <- data.table::fread(file.path(proj_root, "results/sensitivity_nograce_oac/control/sccs_results_adjusted.csv"))
...
dir.create(file.path(proj_root, "results", "sensitivity_nograce_oac"), showWarnings = FALSE, recursive = TRUE)
...
run_and_save_shrinkage <- function(result_df, label, save_ratios = TRUE) {
  ...
  save_both <- function(dt2, stem) {
    out_csv <- file.path(proj_root, "results", "sensitivity_nograce_oac", paste0(stem, ".csv"))
    out_rds <- file.path(proj_root, "results", "sensitivity_nograce_oac", paste0(stem, ".rds"))
  ...
  if (isTRUE(save_ratios)) {
    ...
    if (!is.null(r025)) {
      data.table::fwrite(r025, file.path(proj_root, "results", "sensitivity_nograce_oac", paste0("ratio_vs_pravastatin_", label, "_prior025.csv")))
      saveRDS(r025,              file.path(proj_root, "results", "sensitivity_nograce_oac",paste0("ratio_vs_pravastatin_", label, "_prior025.rds")))
    }
    if (!is.null(r067)) {
      data.table::fwrite(r067, file.path(proj_root, "results", "sensitivity_nograce_oac", paste0("ratio_vs_pravastatin_", label, "_prior067.csv")))
      saveRDS(r067,              file.path(proj_root, "results", "sensitivity_nograce_oac", paste0("ratio_vs_pravastatin_", label, "_prior067.rds")))
    }
  }
}
...
cat("\nSemi-Bayes shrinkage complete for available datasets. Files saved under: ",
    file.path(proj_root, "results", "sensitivity_nograce_oac"), "\n")
```
